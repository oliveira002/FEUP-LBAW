                ...
                <div class="spec d-flex flex-column ps-3 pe-3">
                    <div class="stuf mt-4 mb-4">
                        <div class="d-flex query mt-4">
                            <p class="h3 fw-bold"> All Seller Reports </p>
                        </div>
                                ...
                                @foreach($reports as $rep)
                                    <div class="d-flex align-items-center">
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                $seller = \App\Models\User::find($rep->idseller);
                                                $reporterFull = $reporter->firstname . ' ' . $reporter->lastname;
                                                $sellerFull = $seller->firstname . ' ' . $seller->lastname;
                                                $st = "Solved";
                                                if(!$rep->issolved) {
                                                    $st = "Unsolved";
                                                }
                                            ...
                                            <td class="mt-3"><span class="fw-light">{{$sellerFull}}</span></td>
                                    ...
                                    <div id="modalS-{{($rep->idreport)}}" class="modal-window">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <form action="{{ route('changeStatus',['id' => $rep->idreport])}}" method="post">
                                                @method('put')
                                                @if($rep->issolved)
