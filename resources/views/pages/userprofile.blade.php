                    ...
                    <div class="ms-3">
                        <div class="d-flex">
                            ...
                            <div class="ms-4 mt-3">
                                ...
                                <a href="" class="mb-2 ms-3 h5 rep mt-2">
                                    <button> Report user <i class="fa-regular fa-thumbs-down"></i></button>
                                </a>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="auctions mb-4">
                            ...
                            @foreach($auctions as $auct)
                                <div class="d-flex mt-2 mb-5">
                                    <a href="{{route('auction',['id' => $auct->idauction])}}"> <img class="endimg"
                                                                                                    src="/images/{{$auct->idauction}}/1.jpg"
                                                                                                    width="193"
                                                                                                    height="130"> </a>
                                    <div class="mb-4">
                                        <div>
